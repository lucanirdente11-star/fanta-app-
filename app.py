...
# === CORREZIONE NOMI COMPLETI (espansione abbreviazioni) ===
nome_completo_map = {
    # ATALANTA
    "Carnesecchi": "Marco Carnesecchi",
    "Rossi F.": "Francesco Rossi",
    "Sportiello": "Marco Sportiello",
    "Vismara": "Alessandro Vismara",
    "Ahanor": "Honest Ahanor",
    "Bakker": "Mitchel Bakker",
    "Bellanova": "Raoul Bellanova",
    "Bernasconi": "Lorenzo Bernasconi",
    "Djimsiti": "Berat Djimsiti",
    "Hien": "Isak Hien",
    "Kolasinac": "Sead Kolasinac",
    "Kossounou": "Odilon Kossounou",
    "Kristensen T.": "Thomas Kristensen",
    "Scalvini": "Giorgio Scalvini",
    "Zappacosta": "Davide Zappacosta",
    "Zalewski": "Nicola Zalewski",
    "De Roon": "Marten De Roon",
    "Ederson D.S.": "Éderson Silva",
    "Gaetano": "Gianluca Gaetano",
    "Pasalic": "Mario Pasalic",
    "Samardzic": "Lazar Samardzic",
    "Sulemana I.": "Ibrahim Sulemana",
    "Sulemana K.": "Kamaldeen Sulemana",
    ...
    # BOLOGNA
    "Happonen": "Jesse Happonen",
    "Skorupski": "Lukasz Skorupski",
    "Pessina Mas.": "Massimo Pessina",
    ...
    "Dominguez B.": "Benja Domínguez",
    "Orsolini": "Riccardo Orsolini",
    "Piccoli": "Roberto Piccoli",

    # CAGLIARI
    "Caprile": "Elia Caprile",
    "Ciocci": "Giuseppe Ciocci",
    "Sherri": "Alen Sherri",
    "Raterink": "Othniël Raterink",
    "Idrissi R.": "Riyad Idrissi",
    "Kofler": "Matthias Kofler",
    "Mina": "Yerry Mina",
    "Obert": "Adam Obert",
    "Zè Pedro": "Zé Pedro",
    "Zappa": "Gabriele Zappa",
    "Aurelio": "Marco Aurelio",
    "Adopo": "Michel Adopo",
    "Akarakiri": "Demi Akarakiri",
    "Deiola": "Alessandro Deiola",
    "Liteta": "Joseph Liteta",
    "Prati": "Matteo Prati",
    "Romano": "Alessandro Romano",
    "Winks": "Harry Winks",
    "Albarracin": "Agustín Albarracín",
    "Borrelli": "Gennaro Borrelli",
    "Esposito Se.": "Sebastiano Esposito",
    "Felici": "Mattia Felici",
    "Maldini": "Daniel Maldini",
    "Mutandwa": "Kingstone Mutandwa",
    "Trepy": "Yael Trepy",
    "Kevin Carlos": "Kevin Carlos",
    "Rodriguez Ju.": "Juan Rodríguez",
    "Mendy P.": "Paul Mendy",

    # COMO
    "Audero": "Emil Audero",
    "Butez": "Jean Butez",
    "Tornqvist": "Noel Törnqvist",
    "Vigorito": "Mauro Vigorito",
    "Cuenca A.": "Andrés Cuenca",
    "Dosenna": "Alberto Dossena",
    "Goldaniga": "Edoardo Goldaniga",
    "Kaiki": "Kaiki",
    "Kempf": "Marc Oliver Kempf",
    "Smolcic I.": "Ivan Smolcic",
    "Valle": "Álex Valle",
    "Van Der Brempt": "Ignace Van Der Brempt",
    "Couto": "João Couto",
    "Baturina": "Martin Baturina",
    "Caqueret": "Maxence Caqueret",
    "Da Cunha": "Lucas Da Cunha",
    "Liberali": "Mattia Liberali",
    "Milla": "Luis Milla",
    "Paz N.": "Nico Paz",
    "Perrone": "Máximo Perrone",
    "Rodriguez Je.": "Jesús Rodríguez",
    "Addai": "Jayden Addai",
    "Azon": "Iván Azón",
    "Diao": "Assane Diao",
    "Douvikas": "Tasos Douvikas",
    "Fadera": "Alieu Fadera",
    "Kuhn": "Nicolas Kühn",
    "Lahdo": "Adrian Lahdo",
    "Morata": "Álvaro Morata",
    "Chalobah T.": "Trevoh Chalobah",
    "Ramon": "Jacobo Ramón",

    # FIORENTINA
    "Christensen O.": "Oliver Christensen",
    "De Gea": "David De Gea",
    "Lezzerini": "Luca Lezzerini",
    "Dodò": "Dodô",
    "Dragusin": "Radu Dragusin",
    "Fortini": "Niccolò Fortini",
    "Jimenez A.": "Álex Jiménez",
    "Joao Mario": "João Mário",
    "Parisi": "Fabiano Parisi",
    "Pongracic": "Marin Pongracic",
    "Ranieri L.": "Luca Ranieri",
    "Viery": "Viery",
    "Atta": "Arthur Atta",
    "Brescianini": "Marco Brescianini",
    "Fabbian": "Giovanni Fabbian",
    "Fagioli": "Nicolò Fagioli",
    "Gudmundsson A.": "Albert Gudmundsson",
    "Mandragora": "Rolando Mandragora",
    "Ndour": "Cher Ndour",
    "Oulai": "Christ Inao Oulaï",
    "Valdepenas": "Valdepeñas",
    "Braschi": "Riccardo Braschi",
    "Kean": "Moise Kean",
    "Mastantuono": "Franco Mastantuono",
    "Pellegrino M.": "Mateo Pellegrino",

    # GENOA
    "Bijlow": "Justin Bijlow",
    "Sommariva": "Daniele Sommariva",
    "Stolz": "Franz Stolz",
    "Calvani": "Gabriele Calvani",
    "Marcandalli": "Alessandro Marcandalli",
    "Martin": "Aarón Martín",
    "Matturro": "Alan Matturro",
    "Mitaj": "Mario Mitaj",
    "Norton-Cuffy": "Brooke Norton-Cuffy",
    "Ostigard": "Leo Østigård",
    "Otoa": "Sebastian Otoa",
    "Puczka": "David Puczka",
    "Sabelli": "Stefano Sabelli",
    "Vasquez": "Johan Vásquez",
    "Vogliacco": "Alessandro Vogliacco",
    "Amorim": "Alex Amorim",
    "Ellertsson": "Mikael Ellertsson",
    "Frendrup": "Morten Frendrup",
    "Masini": "Patrizio Masini",
    "Meichtry": "Ethan Meichtry",
    "Messias": "Junior Messias",
    "Sow": "Cheikh Sow",
    "Traorè Hj.": "Hamed Traoré",
    ...
    # INTER
    "Di Gennaro": "Raffaele Di Gennaro",
    "Martinez Jo.": "Josep Martínez",
    "Provedel": "Ivan Provedel",
    "Akanji": "Manuel Akanji",
    "Bastoni": "Alessandro Bastoni",
    "Bisseck": "Yann Bisseck",
    "Carlos Augusto": "Carlos Augusto",
    "Dimarco": "Federico Dimarco",
    "Luis Henrique": "Luis Henrique",
    "Pavard": "Benjamin Pavard",
    "Stones": "John Stones",
    "Asllani": "Kristjan Asllani",
    "Barella": "Nicolò Barella",
    "Calhanoglu": "Hakan Çalhanoglu",
    "Diouf": "Andy Diouf",
    "Frattesi": "Davide Frattesi",
    "Mkhitaryan": "Henrikh Mkhitaryan",
    "Stankovic A.": "Aleksandar Stankovic",
    "Sucic P.": "Petar Sucic",
    "Zielinski": "Piotr Zielinski",
    "Akinsanmiro": "Ebenezer Akinsanmiro",
    "Bonny": "Ange-Yoan Bonny",
    "Esposito F.P.": "Francesco Pio Esposito",
    "Martinez L.": "Lautaro Martínez",
    "Thuram": "Marcus Thuram",

    # JUVENTUS
    "Di Gregorio": "Michele Di Gregorio",
    "Perin": "Mattia Perin",
    "Pinsoglio": "Carlo Pinsoglio",
    "Bremer": "Bremer",
    "Cabal": "Juan Cabal",
    "Cambiaso": "Andrea Cambiaso",
    "Celik": "Zeki Çelik",
    "Gatti": "Federico Gatti",
    "Kalulu": "Pierre Kalulu",
    "Kelly L.": "Lloyd Kelly",
    "Rugani": "Daniele Rugani",
    "Adzic": "Vasilije Adzic",
    "Douglas Luiz": "Douglas Luiz",
    "Koopmeiners": "Teun Koopmeiners",
    "Locatelli": "Manuel Locatelli",
    "McKennie": "Weston McKennie",
    "Miretti": "Fabio Miretti",
    "Thuram K.": "Khéphren Thuram",
    "Alajbegovic": "Kenan Alajbegović",
    "Boga": "Jérémie Boga",
    "Conceicao": "Francisco Conceição",
    "David J.": "Jonathan David",
    "Ekhator": "Jeff Ekhator",
    "Kolo Muani": "Randal Kolo Muani",
    "Yildiz": "Kenan Yildiz",
    "Zhegrova": "Edon Zhegrova",

    # LAZIO
    "Mandas": "Christos Mandas",
    "Motta": "Edoardo Motta",
    "Renzetti": "Davide Renzetti",
    "Doekhi": "Danilho Doekhi",
    "Lazzari": "Manuel Lazzari",
    "Marusic": "Adam Marusic",
    "Patric": "Patric",
    "Pedraza": "Alfonso Pedraza",
    "Provstgaard": "Oliver Provstgaard",
    "Romagnoli": "Alessio Romagnoli",
    "Tavares N.": "Nuno Tavares",
    "Belahyane": "Reda Belahyane",
    "Cataldi": "Danilo Cataldi",
    "Dele-Bashiru": "Fisayo Dele-Bashiru",
    "Floriani Mussolini": "Romano Floriani Mussolini",
    "Isaksen": "Gustav Isaksen",
    "Pellegrini Lu.": "Luca Pellegrini",
    "Przyborek": "Adrian Przyborek",
    "Rovella": "Nicolò Rovella",
    "Taylor K.": "Kenneth Taylor",
    "Cancellieri": "Matteo Cancellieri",
    "Dia": "Boulaye Dia",
    "Noslin": "Tijjani Noslin",
    "Ratkov": "Petar Ratkov",
    "Zaccagni": "Mattia Zaccagni",

    # LECCE
    "Falcone": "Wladimiro Falcone",
    "Fruchtl": "Christian Früchtl",
    "Samooja": "Jasper Samooja",
    "Penev": "Bozhidar Penev",
    "Gallo": "Antonino Gallo",
    "Gaspar K.": "Kialonda Gaspar",
    "Jean": "Gaby Jean",
    "Ndaba": "Corrie Ndaba",
    "Siebert": "Jamil Siebert",
    "Tiago Gabriel": "Tiago Gabriel",
    "Veiga D.": "Danilo Veiga",
    "Berisha M.": "Medon Berisha",
    "Coulibaly L.": "Lassana Coulibaly",
    "Fofana Sa.": "Sadik Fofana",
    "Gandelman": "Omri Gandelman",
    "Geubbels": "Willem Geubbels",
    "Gorter": "Olaf Gorter",
    "Kaba": "Mohamed Kaba",
    "Maleh": "Youssef Maleh",
    "Ngom": "Oumar Ngom",
    "N'Dri": "Konan N'dri",
    "Pierotti": "Santiago Pierotti",
    "Stulic": "Nikola Stulic",
    "Banda": "Lameck Banda",

    # MILAN
    "Maignan": "Mike Maignan",
    "Terracciano": "Pietro Terracciano",
    "Torriani": "Lorenzo Torriani",
    "Athekame": "Zachary Athekame",
    "Bartesaghi": "Davide Bartesaghi",
    "De Winter": "Koni De Winter",
    "Estupinan": "Pervis Estupiñán",
    "Gabbia": "Matteo Gabbia",
    "Gila": "Mario Gila",
    "Pavlovic": "Strahinja Pavlovic",
    "Tomori": "Fikayo Tomori",
    "Bennacer": "Ismaël Bennacer",
    "Chukwueze": "Samuel Chukwueze",
    "Diawara S.": "Sankhoun Diawara",
    "Fofana Y.": "Youssouf Fofana",
    "Jashari": "Ardon Jashari",
    "Loftus-Cheek": "Ruben Loftus-Cheek",
    "Musah": "Yunus Musah",
    "Ricci S.": "Samuele Ricci",
    ...
    # NAPOLI
    "Contini": "Nikita Contini",
    "Meret": "Alex Meret",
    "Milinkovic-Savic V.": "Vanja Milinkovic-Savic",
    "Beukema": "Sam Beukema",
    "Buongiorno": "Alessandro Buongiorno",
    "Di Lorenzo": "Giovanni Di Lorenzo",
    "Gutierrez": "Miguel Gutiérrez",
    "Marin R.": "Rafa Marín",
    "Marianucci": "Luca Marianucci",
    "Olivera": "Mathías Olivera",
    "Rrahmani": "Amir Rrahmani",
    "Spinazzola": "Leonardo Spinazzola",
    "Anguissa": "Frank Anguissa",
    "De Bruyne": "Kevin De Bruyne",
    "Folorunsho": "Michael Folorunsho",
    "Gilmour": "Billy Gilmour",
    "Giovane": "Giovane",
    "Lang": "Noa Lang",
    "Lobotka": "Stanislav Lobotka",
    "McTominay": "Scott McTominay",
    "Santos A.": "Alisson Santos",
    "Vergara": "Antonio Vergara",
    ...
    # PARMA
    "Corvi": "Edoardo Corvi",
    "Daffara": "Giovanni Daffara",
    "Suzuki": "Zion Suzuki",
    "Carboni F.": "Franco Carboni",
    "Circati": "Alessandro Circati",
    "Delprato": "Enrico Delprato",
    "Ndiaye": "Abdoulaye Ndiaye",
    "Troilo": "Mariano Troilo",
    "Valenti": "Lautaro Valenti",
    "Valeri": "Emanuele Valeri",
    "Bernabè": "Adrián Bernabé",
    "Britschgi": "Sascha Britschgi",
    "Cremaschi": "Benjamín Cremaschi",
    "Diallo O.": "Ousmane Diallo",
    "Elphege": "Nesta Elphege",
    "Keita M.": "Mandela Keita",
    "Nicolussi Caviglia": "Hans Nicolussi Caviglia",
    "Ordonez C.": "Christian Ordóñez",
    "Sorensen O.": "Oliver Sørensen",
    "Tourè E.": "El Bilal Touré",
    "Almqvist": "Pontus Almqvist",
    "Frigan": "Matija Frigan",
    "Ondrejka": "Jacob Ondrejka",
    "Pellegrino M.": "Mateo Pellegrino",

    # ROMA
    "Gollini": "Pierluigi Gollini",
    "Svilar": "Mile Svilar",
    "Vasquez": "Devis Vásquez",
    "Zelezny": "Radoslaw Zelezny",
    "Angelino": "Angeliño",
    "De Marzi": "Giorgio De Marzi",
    "Ghilardi": "Daniele Ghilardi",
    "Hermoso": "Mario Hermoso",
    "Koulierakis": "Konstantinos Koulierakis",
    "Mancini": "Gianluca Mancini",
    "N'Dicka": "Evan Ndicka",
    "Rensch": "Devyne Rensch",
    "Wesley": "Wesley",
    "Ziolkowski": "Jan Ziólkowski",
    "Cristante": "Bryan Cristante",
    "El Aynaoui": "Neil El Aynaoui",
    "Konè M.": "Manu Koné",
    "Pellegrini Lo.": "Lorenzo Pellegrini",
    "Pisilli": "Niccolò Pisilli",
    "Arena": "Antonio Arena",
    "Castro S.": "Santiago Castro",
    "Dovbyk": "Artem Dovbyk",
    "Dybala": "Paulo Dybala",
    "Malen": "Donyell Malen",
    "Molina N.": "Nahuel Molina",
    "Soulè": "Matías Soulé",
    "Vaz": "Robinio Vaz",

    # TORINO
    "Israel": "Franco Israel",
    "Mascardi": "Diego Mascardi",
    "Paleari": "Alberto Paleari",
    "Siviero": "Lapo Siviero",
    "Biraghi": "Cristiano Biraghi",
    "Coco": "Saúl Coco",
    "Comert": "Eray Cömert",
    "Comuzzo": "Pietro Comuzzo",
    "Ismajli": "Ardian Ismajli",
    "Pedersen": "Marcus Pedersen",
    "Anjorin": "Tino Anjorin",
    "Casadei": "Cesare Casadei",
    "Fitz-Jim": "Youri Fitz-Jim",
    "Gineitis": "Gvidas Gineitis",
    "Ilkhan": "Emirhan Ilkhan",
    "Ilic": "Ivan Ilic",
    "Oristanio": "Gaetano Oristanio",
    "Aboukhlal": "Zakaria Aboukhlal",
    "Adams C.": "Ché Adams",
    "Kulenovic": "Sandro Kulenovic",
    "Njie": "Alieu Njie",
    "Simeone": "Giovanni Simeone",
    "Vlasic": "Nikola Vlasic",
    "Zapata D.": "Duván Zapata",

    # UDINESE
    "Okoye": "Maduka Okoye",
    "Padelli": "Daniele Padelli",
    "Piana": "Edoardo Piana",
    "Abankwah": "James Abankwah",
    "Bertola": "Nicolò Bertola",
    "Camara A.": "Abdoulaye Camara",
    "Ebosse": "Enzo Ebosse",
    "Goglichidze": "Saba Goglichidze",
    "Kabasele": "Christian Kabasele",
    "Kamara H.": "Hassane Kamara",
    "Kristensen T.": "Thomas Kristensen",
    "Palma": "Matteo Palma",
    "Solet": "Oumar Solet",
    "Vojvoda": "Mërgim Vojvoda",
    "Zanoli": "Alessandro Zanoli",
    "Arizala": "Juan Arizala",
    "Chakvetadze": "Giorgi Chakvetadze",
    "Ekkelenkamp": "Jurgen Ekkelenkamp",
    "Gueye": "Idrissa Gueye",
    "Karlstrom": "Jesper Karlström",
    "Miller L.": "Lennon Miller",
    "Piotrowski": "Jakub Piotrowski",
    "Unai Gomez": "Unai Gómez",
    "Zarraga": "Oier Zarraga",
    "Bayo V.": "Vakoun Bayo",
    "Buksa": "Adam Buksa",
    "Davis K.": "Keinan Davis",
    "Zaniolo": "Nicolò Zaniolo",

    # VENEZIA
    "Grandi": "Matteo Grandi",
    "Pozzi": "Alessio Pozzi",
    "Stankovic F.": "Filip Stankovic",
    "Gomes": "Ale Gomes",
    "Bella-Kotchap": "Armel Bella-Kotchap",
    "Correia T.": "Thierry Correia",
    "Franjic": "Bartol Franjic",
    "Halhal": "Halhal",
    "Haps": "Ridgeciano Haps",
    "Moreno M.": "Matías Moreno",
    "Rrahmani Al.": "Albion Rrahmani",
    "Sagrado": "Richie Sagrado",
    "Schingtienne": "Joël Schingtienne",
    "Sverko": "Marin Sverko",
    "Basic": "Toma Basic",
    "Bjarkason": "Bjarki Bjarkason",
    "Bohinen": "Emil Bohinen",
    "Busio": "Gianluca Busio",
    "Dagasso": "Matteo Dagasso",
    "Duncan": "Alfred Duncan",
    "Hainaut": "Antoine Hainaut",
    "Helgason": "Thórir Helgason",
    "Lauberbach": "Lion Lauberbach",
    "Lisman": "Kornel Lisman",
    "Perez K.": "Kike Pérez",
    "Sohm": "Simon Sohm",
    "Adams A.": "Akor Adams",
    "Adorante": "Andrea Adorante",
    "Yeboah J.": "John Yeboah",

    # FROSINONE
    "Desplanches": "Sebastiano Desplanches",
    "Lolic": "Eldin Lolic",
    "Palmisani": "Lorenzo Palmisani",
    "Akpoguma": "Kevin Akpoguma",
    "Amey": "Wisdom Amey",
    "Bracaglia": "Gabriele Bracaglia",
    "Calvani": "Gabriele Calvani",
    "Cittadini": "Giorgio Cittadini",
    "Corrado": "Niccolò Corrado",
    "Gelli J.": "Jacopo Gelli",
    "Monterisi": "Ilario Monterisi",
    "Oyono A.": "Anthony Oyono",
    "Oyono J.": "Jérémy Oyono",
    "Calò": "Giacomo Calò",
    "Cichella": "Matteo Cichella",
    "El Azzouzi A.": "Anouar El Azzouzi",
    "Fini": "Seydou Fini",
    "Gelli F.": "Francesco Gelli",
    "Grillitsch": "Florian Grillitsch",
    "Hasa": "Luis Hasa",
    "Kone B.": "Ben Kone",
    "Koutsoupias": "Ilias Koutsoupias",
    "Schmid": "Marvin Schmid",
    "Ghedjemis": "Farès Ghedjemis",
    "Kvernadze": "Giorgi Kvernadze",
    "Raimondo": "Antonio Raimondo",
    "Zerbin": "Alessio Zerbin",

    # MONZA
    "Pizzignacco": "Semuel Pizzignacco",
    "Strajnar": "Aljaz Strajnar",
    "Thiam": "Demba Thiam",
    "Antov": "Valentin Antov",
    "Bakoune": "Adam Bakoune",
    "Birindelli": "Samuele Birindelli",
    "Carboni A.": "Andrea Carboni",
    "Delli Carri": "Filippo Delli Carri",
    "Lucchesi": "Lorenzo Lucchesi",
    "Mangas": "Ricardo Mangas",
    "Robinson J.": "Jack Robinson",
    "Ciurria": "Patrick Ciurria",
    "Colpani": "Andrea Colpani",
    "Kouadio": "Eddy Kouadio",
    "Pessina": "Matteo Pessina",
    "Baldé": "Keita Baldé",
    "Cutrone": "Patrick Cutrone",
    "Mota": "Dany Mota",
    "Petagna": "Andrea Petagna",
    "Varela G.": "Gustavo Varela",
    "Colombo L.": "Leonardo Colombo",

    # SASSUOLO
    "Muric": "Arijanet Muric",
    "Satalino": "Gianluca Satalino",
    "Turati": "Stefano Turati",
    "Candè": "Fali Candé",
    "Doig": "Josh Doig",
    "Idzes": "Jay Idzes",
    "Missori": "Filippo Missori",
    "Pieragnolo": "Edoardo Pieragnolo",
    "Walukiewicz": "Sebastian Walukiewicz",
    "Bakola": "Darryl Bakola",
    "Boloca": "Daniel Boloca",
    "Iannoni": "Edoardo Iannoni",
    "Konè I.": "Ismaël Koné",
    "Lipani": "Luca Lipani",
    "Matic": "Nemanja Matic",
    ...
    "Bowie": "Bowie",
    "Laurientè": "Armand Laurienté",
    "Moro L.": "Luca Moro",
    "Pinamonti": "Andrea Pinamonti",
    "Russo A.": "Flavio Russo",
}
