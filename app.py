...
st.caption("Il tuo assistente completo: database, percentuali di titolarità e calcoli per l'asta.")
...
def load_data():
    giocatori = [
        ...
        # DIFENSORI
        {"Nome": "Dimarco", "Squadra": "Inter", "Ruolo": "Difensore", "Titolarita_%": 85, "Status": "Titolare (Turnover)", "Rigorista": "No", "Convenienza": 9.5, "Quotazione": 22, "Note": "Bonus da centrocampista top."},
        {"Nome": "Theo Hernandez", "Squadra": "Milan", "Ruolo": "Difensore", "Titolarita_%": 90, "Status": "Titolare fisso", "Rigorista": "Vice", "Convenienza": 9.0, "Quotazione": 20, "Note": "Garantisce gol e assist."},
        {"Nome": "Bremer", "Squadra": "Juventus", "Ruolo": "Difensore", "Titolarita_%": 95, "Status": "Titolare inamovibile", "Rigorista": "No", "Convenienza": 8.8, "Quotazione": 17, "Note": "Pilastro da modificatore."},
        ...
        # CENTROCAMPISTI
        {"Nome": "Pulisic", "Squadra": "Milan", "Ruolo": "Centrocampista", "Titolarita_%": 85, "Status": "Titolare / Rigorista", "Rigorista": "Sì", "Convenienza": 9.6, "Quotazione": 28, "Note": "Tra i migliori del listone."},
        {"Nome": "Calhanoglu", "Squadra": "Inter", "Ruolo": "Centrocampista", "Titolarita_%": 90, "Status": "Titolare / Rigorista", "Rigorista": "Sì", "Convenienza": 9.4, "Quotazione": 26, "Note": "Cecchino dagli undici metri."},
        ...
        # ATTACCANTI
        {"Nome": "Lautaro Martinez", "Squadra": "Inter", "Ruolo": "Attaccante", "Titolarita_%": 90, "Status": "Top Slot / Rigorista", "Rigorista": "Sì", "Convenienza": 9.8, "Quotazione": 42, "Note": "Super top d'attacco."},
        ...
        {"Nome": "Retegui", "Squadra": "Atalanta", "Ruolo": "Attaccante", "Titolarita_%": 80, "Status": "Titolare", "Rigorista": "Sì", "Convenienza": 8.8, "Quotazione": 32, "Note": "Macchina da bonus con Gasperini."},
...
# --- TAB DEDICATI ---
tab1, tab2, tab3 = st.tabs(["🔍 Cerca Giocatore & Calcolo Asta", "📊 Listone & Filtri", "📰 Calciomercato & Ultim'ora"])
...
with tab1:
    ...
    if search_query != "-- Scegli un giocatore --":
        ...
        col3.metric("Convenienza", f"{player['Convenienza']}/10")
        ...
        * **Analisi Tattica:** {player['Note']}
        ...
        if int(max_spesa) > 0:
            st.info(f"💡 **Consiglio Asta:** Non superare la soglia dei **{int(max_spesa)} crediti** per questo giocatore.")
...
# --- TAB 3: CALCIOMERCATO E NEWS ---
with tab3:
    st.subheader("📰 Link Diretti per le Notizie Live")
    st.info("Consulta le notizie aggiornate in tempo reale sui principali portali di Fantacalcio:")
    st.markdown("- [ La Gazzetta dello Sport - Calcio](https://www.gazzetta.it/Calcio/)")
    st.markdown("- [ Fantacalcio.it - Probabili Formazioni](https://www.fantacalcio.it/probabili-formazioni-serie-a)")
    st.markdown("- [ Sky Sport - Calciomercato](https://sport.sky.it/calciomercato)")
